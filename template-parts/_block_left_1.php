...
<div class=" col-md-6 text-center cf l-m-1" style="background:<?php the_field('colour_picker_1') ?>">
   
    <?php if(!empty($text_1)) { ?>
        <h4><?php echo $text_1; ?></h4>
    <?php } 
    else { ?>
        <style type="text/css">.l-m-1{
        display:none;
        }</style>
        <?php } ?>
    ...
    <div id="left-1-div">
        ...
        <?php if(!empty($text_2)) { ?>
            <p class="d-block p1-display"><?php echo $text_2; ?></p>
        <?php } 
        else { ?>
    ...
    <div id="left-2-div">
        ...
        <?php if(!empty($text_3)) { ?>
        <p class="d-block p2-display">"<?php echo $text_3; ?></p>
        <?php } 
        else { ?>
        ...
        <?php if(!empty($text_4)) { ?>
        <p class="d-block ligther p3-display"><?php echo $text_4; ?></p>
        <?php } 
        else { ?>
